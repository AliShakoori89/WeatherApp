  ...
  Widget build(BuildContext context) {
    ...
    return Column (
      children: [
        ...
        cityInput (context,widget.hintText,widget.focusNode,cityNameController),
        SizedBox (height: MediaQuery.of (context).size.height / 100,),
      ],
    );
  }

  Widget cityInput(BuildContext context, String hintText, FocusNode focusNode, TextEditingController cityNameController) {
